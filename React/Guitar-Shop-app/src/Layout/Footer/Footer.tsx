export function Footer() {
  return (
    <div className="h-[380px] bg-[#EEEEEE]">
      <div className="py-20 px-40 flex justify-between">
        <div className="flex flex-col gap-12">
          <div className="flex gap-3">
            <img src="..\src\img\Butterfly.svg" alt="" />{" "}
            <span className="text-4xl">VibeStrings</span>
          </div>
          <div className="flex flex-col gap-6">
            <div className="flex gap-4">
              ...
              <p className="text-[#666666]">Enquiry@VibeStrings.com</p>
            </div>
            <div className="flex gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_4418_9456)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_4418_9456">
                    <rect width="24" height="24" fill="white" />
                  </clipPath>
                </defs>
              </svg>
              <p className="text-[#666666]">San Francisco</p>
            </div>
          </div>
        </div>
        <div className="flex gap-32">
          <div className="flex flex-col gap-4">
            <p className="text-[20px] font-bold">PAGES</p>
            <div className="flex flex-col gap-3">
              <p className="text-[#666666]">Store</p>
              <p className="text-[#666666]">Collection</p>
              <p className="text-[#666666]">Support</p>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <p className="text-[20px] font-bold">PRODUCT</p>
            <div className="flex flex-col gap-3">
              <p className="text-[#666666]">Terms</p>
              <p className="text-[#666666]">Privacy Policy</p>
              <p className="text-[#666666]">Copyright</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-12">
            ...
            >
              <path
                ...
                className="color3c5a9a svgShape"
              ></path>
            </svg>
            <svg
            ...
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_4418_9861)">
                <path
      ...
      <p className="text-center text-[#666666]">© 2022 Copyright.VibeStrings</p>
    </div>
  );
}
